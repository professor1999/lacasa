    ...
    break;
      ...
      var voiceChannel = message.member.voiceChannel;
        ...
        message.channel.send(':wave:')
          break;
      case "queue":
      message.channel.send('`Sorry, but I do not support queues at this time. Please invite HackerBot Music for those commands`')

      break;
      case "skip":
      message.channel.send('`Sorry, but I do not support skipping at this time. Please invite HackerBot Music for those commands`')
  ...
  if(usernick < 1) return message.channel.send({embed: nickembed}).catch(console.error);
    ...
    case ":d":
      ...
      case "rage":
        ...
        .setColor(`00FF00`)
        .setTitle('HackerBot Uptime (Seconds)')
        .addField('Uptime Seconds', seconds)

        var minuteupembed = new Discord.RichEmbed()
        .setColor('00FF00')
        .setTitle('HackerBot Uptime (Minutes)')
        .addField('Uptime Minutes', minutes)

        var hourupembed = new Discord.RichEmbed()
        .setColor('00FF00')
        .setTitle('HackerBot Uptime (Hours)')
        .addField('Uptime Hours', hours)

        var dayupembed = new Discord.RichEmbed()
        .setColor('00FF00')
        .setTitle('HackerBot Uptime (Days)')
        .addField('Uptime Days', days)
  ...
  if (isStaffchannelcreate) {
	...
	var config = require("./config.json");
      ...
      var helpembed = new Discord.RichEmbed()
        ...
        .setColor('00FF00')
        .setTitle('Help Help')
        .setDescription('Get a list of commands available with HackerBot')
        ...
        var websiteembed = new Discord.RichEmbed()
          ...
          .setDescription('Sends a link to the HackerBot Website')
        ...
        var musicwebsiteembed = new Discord.RichEmbed()
          ...
          .setDescription('Sends a link to the HackerBot Music Website')
        ...
        if(helpcommand === `play`) return message.channel.send('You must invite HackerBot Music for this command - https://discordapp.com/oauth2/authorize?client_id=365255372480446465&scope=bot&permissions=2146958591')
        if(helpcommand === `pause`) return message.channel.send('You must invite HackerBot Music for this command - https://discordapp.com/oauth2/authorize?client_id=365255372480446465&scope=bot&permissions=2146958591')
        if(helpcommand === `queue`) return message.channel.send('You must invite HackerBot Music for this command - https://discordapp.com/oauth2/authorize?client_id=365255372480446465&scope=bot&permissions=2146958591')
        if(helpcommand === `clear`) return message.channel.send('You must invite HackerBot Music for this command - https://discordapp.com/oauth2/authorize?client_id=365255372480446465&scope=bot&permissions=2146958591')
        if(helpcommand === `skip`) return message.channel.send('You must invite HackerBot Music for this command - https://discordapp.com/oauth2/authorize?client_id=365255372480446465&scope=bot&permissions=2146958591')
